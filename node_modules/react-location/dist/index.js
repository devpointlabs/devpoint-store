...
var useLocation = function useLocation() {
  ...
  var query = contextValue.query,
      ...
      pathname = contextValue.pathname; // Make sure any components using this hook update when the
  // history changes
  ...
  var navigate = React.useCallback(function (to) {
    ...
    var href = resolve(to, navigateRef.current.basepath) + (search === '?' ? '' : search); // If this is a preview, just return the final href
...
var Redirect = function Redirect(_ref7) {
  var _ref7$from = _ref7.from,
      from = _ref7$from === void 0 ? '/' : _ref7$from,
      to = _ref7.to,
      query = _ref7.query,
      state = _ref7.state,
